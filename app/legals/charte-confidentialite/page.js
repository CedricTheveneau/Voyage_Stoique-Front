...
<p>Cela ne s&apos;effectuera que si vous nous en donnez l&apos;autorisation, via le formulaire de paramétrage des cookies, présenté par axeptio, lors de votre arrivée sur le site.</p>
                ...
                <div className="info">
                    ...
                    <p>Pour faire respecter ses droits, l&apos;utilisateur peut, à tout instant, envoyer sa demande aux adresses suivantes : <Link href="mailto:dpo.voyagestoique@gmail.com" title="Adresser par email une demande de faire valoir de ses droits">dpo.voyagestoique@gmail.com</Link> | <Link href="mailto:contact.voyagestoique@gmail.com" title="Adresser par email une demande de faire valoir de ses droits">contact.voyagestoique@gmail.com</Link> | <Link href="mailto:theveneaucedricpro@gmail.com" title="Adresser par email une demande de faire valoir de ses droits">theveneaucedricpro@gmail.com</Link>.</p>
                </div>
                <div className="info">
